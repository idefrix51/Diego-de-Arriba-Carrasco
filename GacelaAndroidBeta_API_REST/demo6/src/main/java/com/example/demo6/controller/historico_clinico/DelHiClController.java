...
@RequestMapping("/api")
@CrossOrigin("*")
public class DelHiClController {
    private DAOFactory factory = DAOFactory.getDAOFactory(DAOFactory.ORM);
    private Historico_clinicoDAO pacienteDAO = factory.getHistorico_clinicoDAO();

    @Operation(summary = "Endpoint para eliminar historicos clinicos")
    @ApiResponses(value = {
    ...
    @DeleteMapping(value = "/historicosClinicos/{id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    public void eliminarHistoricosClinicos(@PathVariable int id) {
