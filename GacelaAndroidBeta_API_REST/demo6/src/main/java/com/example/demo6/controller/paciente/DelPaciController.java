...
public class DelPaciController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "Error inesperado del sistema",
                    content = @Content)})
    @DeleteMapping(value = "/pacientes/{id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    public void eliminarPacientes(@PathVariable int id) {
