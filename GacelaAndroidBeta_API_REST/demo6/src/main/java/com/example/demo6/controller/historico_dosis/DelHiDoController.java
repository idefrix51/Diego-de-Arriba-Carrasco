...
@RequestMapping("/api")
@CrossOrigin("*")
public class DelHiDoController {
    private DAOFactory factory = DAOFactory.getDAOFactory(DAOFactory.ORM);
    private Historico_dosisDAO pacienteDAO = factory.getHistorico_dosisDAO();

    @Operation(summary = "Endpoint para eliminar historicos de dosis")
    @ApiResponses(value = {
    ...
    @DeleteMapping(value = "/historicosDosis/{id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    public void eliminarHistoricosDosis(@PathVariable int id) {
