...
@RequestMapping("/api")
@CrossOrigin("*")
public class InsReGoController {
    private DAOFactory factory = DAOFactory.getDAOFactory(DAOFactory.ORM);
    private Registro_GoogleFitDAO pacienteDAO = factory.getRegistro_GoogleFitDAO();

    @Operation(summary = "Endpoint para insertar registros de GoogleFit")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Registro_GoogleFitDTO> insertarRegistroGoogleFit(@RequestBody Registro_GoogleFitDTO dto) throws Exception {
        ...
        return new ResponseEntity<>(Registro_GoogleFitAssembler.pasearADTO(paciente), HttpStatus.CREATED);
    }
}
