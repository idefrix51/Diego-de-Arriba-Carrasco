...
@RequestMapping("/api")
@CrossOrigin("*")
public class DelMediController {
    private DAOFactory factory = DAOFactory.getDAOFactory(DAOFactory.ORM);
    private MedicamentoDAO pacienteDAO = factory.getMedicamentoDAO();

    @Operation(summary = "Endpoint para eliminar medicamentos")
    @ApiResponses(value = {
    ...
    @DeleteMapping(value = "/medicamentos/{id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    public void eliminarMedicamentos(@PathVariable int id) {
