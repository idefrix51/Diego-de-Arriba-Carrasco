...
@RequestMapping("/api")
@CrossOrigin("*")
public class DelVariController {
    private DAOFactory factory = DAOFactory.getDAOFactory(DAOFactory.ORM);
    private VariableDAO pacienteDAO = factory.getVariableDAO();

    @Operation(summary = "Endpoint para eliminar variables")
    @ApiResponses(value = {
    ...
    @DeleteMapping(value = "/variables/{id}", produces = {MediaType.APPLICATION_JSON_VALUE})
    public void eliminarVariables(@PathVariable int id) {
